...
/// A wrapper for an `Endpoint` that implements `tower::Service`.
...
/// A wrapper for a `tower::Service` that implements `Endpoint`.
pub struct ServiceEndpoint<S>(pub S);

impl<S, E> Endpoint for ServiceEndpoint<S>
where
    ...
    E: std::fmt::Display + Send + 'static,
{
    fn call(&self, req: OxiditeRequest) -> Pin<Box<dyn Future<Output = Result<OxiditeResponse>> + Send>> {
        ...
        Box::pin(async move {
            this.call(req).await.map_err(|e| Error::InternalServerError(e.to_string()))
        })
    }
}
...
where
    ...
    Fut: Future<Output = Result<OxiditeResponse>> + Send + 'static,
    T1, T2, T3, T4: FromRequest + Send + 'static,
{
    fn call(&self, mut req: OxiditeRequest) -> Pin<Box<dyn Future<Output = Result<OxiditeResponse>> + Send>> {
        let handler = self.clone();
        Box::pin(async move {
...
where
    ...
    Fut: Future<Output = Result<OxiditeResponse>> + Send + 'static,
    T1, T2, T3, T4, T5: FromRequest + Send + 'static,
{
    fn call(&self, mut req: OxiditeRequest) -> Pin<Box<dyn Future<Output = Result<OxiditeResponse>> + Send>> {
        let handler = self.clone();
        Box::pin(async move {
...
where
    ...
    Fut: Future<Output = Result<OxiditeResponse>> + Send + 'static,
    T1, T2, T3, T4, T5, T6: FromRequest + Send + 'static,
{
    fn call(&self, mut req: OxiditeRequest) -> Pin<Box<dyn Future<Output = Result<OxiditeResponse>> + Send>> {
        let handler = self.clone();
        Box::pin(async move {
...
where
    ...
    Fut: Future<Output = Result<OxiditeResponse>> + Send + 'static,
    T1, T2, T3, T4, T5, T6, T7: FromRequest + Send + 'static,
{
    fn call(&self, mut req: OxiditeRequest) -> Pin<Box<dyn Future<Output = Result<OxiditeResponse>> + Send>> {
        let handler = self.clone();
        Box::pin(async move {
...
where
    ...
    Fut: Future<Output = Result<OxiditeResponse>> + Send + 'static,
    T1, T2, T3, T4, T5, T6, T7, T8: FromRequest + Send + 'static,
{
    fn call(&self, mut req: OxiditeRequest) -> Pin<Box<dyn Future<Output = Result<OxiditeResponse>> + Send>> {
        let handler = self.clone();
        Box::pin(async move {
...
// Implement Handler for Fn(T1, T2, T3, T4, T5, T6, T7, T8, T9) -> Fut
...
where
    ...
    Fut: Future<Output = Result<OxiditeResponse>> + Send + 'static,
    T1, T2, T3, T4, T5, T6, T7, T8, T9: FromRequest + Send + 'static,
{
    fn call(&self, mut req: OxiditeRequest) -> Pin<Box<dyn Future<Output = Result<OxiditeResponse>> + Send>> {
        let handler = self.clone();
        Box::pin(async move {
...
// Implement Handler for Fn(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10) -> Fut
...
where
    ...
    Fut: Future<Output = Result<OxiditeResponse>> + Send + 'static,
    T1, T2, T3, T4, T5, T6, T7, T8, T9, T10: FromRequest + Send + 'static,
{
    fn call(&self, mut req: OxiditeRequest) -> Pin<Box<dyn Future<Output = Result<OxiditeResponse>> + Send>> {
        let handler = self.clone();
        Box::pin(async move {
...
// Implement Handler for Fn(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11) -> Fut
...
where
    ...
    Fut: Future<Output = Result<OxiditeResponse>> + Send + 'static,
    T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11: FromRequest + Send + 'static,
{
    fn call(&self, mut req: OxiditeRequest) -> Pin<Box<dyn Future<Output = Result<OxiditeResponse>> + Send>> {
        let handler = self.clone();
        Box::pin(async move {
...
// Implement Handler for Fn(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12) -> Fut
...
where
    ...
    Fut: Future<Output = Result<OxiditeResponse>> + Send + 'static,
    T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12: FromRequest + Send + 'static,
{
    fn call(&self, mut req: OxiditeRequest) -> Pin<Box<dyn Future<Output = Result<OxiditeResponse>> + Send>> {
        let handler = self.clone();
        Box::pin(async move {
